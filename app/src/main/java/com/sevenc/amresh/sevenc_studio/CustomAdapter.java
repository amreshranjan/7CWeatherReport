...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Activity mainActivity, ArrayList<String> dateTime,ArrayList<String> temperature, ArrayList<Integer> climateImages, ArrayList<Weather> weatherList) {
